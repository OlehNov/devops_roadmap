...
@extend_schema(
    ...
    description=(
        ...
        "- `GET http://localhost:8181/api/v1/glamps/?filters[type_glamp__name][$startsWith]=Eco` \n\n"
        "`$startsWithi` - **Starts with (case-insensitive)**\n\n"
        "- `GET http://localhost:8181/api/v1/glamps/?filters[name][$startsWithi]=GleMP` \n\n"
        "- `GET http://localhost:8181/api/v1/glamps/?filters[type_glamp__name][$startsWithi]=eCo` \n\n"
        "`$endsWith` - **Ends with**\n\n"
        ...
        "- `GET http://localhost:8181/api/v1/glamps/?filters[type_glamp__name][$startsWithi]=еКо&filters[price][$between]=1200,10000` \n\n"
