...
from glamps.permissions import (IsAnonymousUser, IsGlampOwner, RoleIsAdmin,
                                RoleIsManager, RoleIsOwner, RoleIsTourist)
from glamps.serializers import GlampByCategoryViewSet, GlampSerializer
